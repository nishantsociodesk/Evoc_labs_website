...
import { TrendingUp, LucideIcon, Zap } from "lucide-react";
import { ReactNode } from "react";

export function Features() {
  return (
    <section className="bg-[#08070b] py-16 md:py-32 border-b border-white/[0.08]">
        ...
        <div className="mx-auto grid gap-4 lg:grid-cols-2">
          <FeatureCard>
            <CardHeader className="pb-3">
              <CardHeading
                ...
                description="Advanced data tracking. Instantly monitor your sales channels and marketing ROI."
              />
            </CardHeader>

            <div className="relative mb-6 border-t border-dashed sm:mb-0">
              <div className="absolute inset-0 [background:radial-gradient(125%_125%_at_50%_0%,transparent_40%,hsl(var(--muted)),#0d0c11_125%)]"></div>
              <div className="aspect-[76/59] p-1 px-6">
                <DualModeImage
                  darkSrc="https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&q=80&w=1207"
                  lightSrc="https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&q=80&w=1207"
          ...
          <FeatureCard>
            <CardHeader className="pb-3">
              <CardHeading
                ...
                description="Smart marketing automation. Schedule drops, flash sales, and email sequences seamlessly."
              />
            </CardHeader>
            ...
            <CardContent>
              <div className="relative mb-6 sm:mb-0">
                ...
                <div className="aspect-[76/59] border border-white/10 rounded-lg overflow-hidden">
                  <DualModeImage
                    darkSrc="https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?auto=format&fit=crop&q=80&w=1207"
                    lightSrc="https://images.unsplash.com/photo-1563013544-824ae1b704d3?auto=format&fit=crop&q=80&w=1207"
                    alt="E-commerce shopping cart and automation"
                    width={1207}
                    height={929}
          ...
          <FeatureCard className="p-6 lg:col-span-2">
            <p className="mx-auto my-6 max-w-md text-balance text-center text-2xl font-semibold text-white">
              Seamless multi-platform integration to unify your e-commerce
              ecosystem.
            </p>
...
const CircularUI = ({ label, circles, className }: CircularUIProps) => (
  <div className={className}>
    ...
    <span className="text-[#8a8f98] mt-1.5 block text-center text-sm">
      {label}
    </span>
  </div>
);
